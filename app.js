...
// // 2. Convert string x to lower-case and assign to the same variable
// x = x.toLowerCase();
...
// // 1. Slice "ap" out of "captain" and assign the result to the variable "sameWords"
// var sameWords = "captain";
// sameWords = sameWords.slice(0, 1) + sameWords.slice(3);

// // 2. Get the number of characters in a string and assign it to a variable
// var stringLength = sameWords.length;

// // 3. Slice the four middle characters out of "elephant" and assign it to a new variable "seg"
// var animal = "elephant";
// var seg = animal.slice(1, 5);

// // 4. Find the number of characters in a string represented by a variable and assign it to a second variable
// var variableString = "exampleString";
// var secondVariable = variableString.length;

// // 5. Measure the number of characters in a string and slice specific parts to a new variable
// var testString = "testingString";
// var secondVariableString = testString.length;
// var slicedString = testString.slice(1, -3);

// // 6. Find the value of indx when using text.indexOf("be");
// var text = "To be or not to be.";
// var indx = text.indexOf("be"); // indx will be 3

// // 7. Find the value of indx when using text.lastIndexOf("be");
// var indx = text.lastIndexOf("be"); // indx will be 16

// // 8. Find the index of the first character of the last instance of "go" in the string represented by the variable text
// var indx;
// var text = "Some text goes here and there, go for it!";
// indx = text.lastIndexOf("go");

// // 9. First line of an if statement testing whether a segment with an index represented by indexNum exists in a string
// if (text[indexNum]) {
//   // Code here if the segment exists
// }
...
// var cha = text.charAt(9); // Index starts from 0, so the 10th character is at index 9
...
// var cha = input.charAt(4); // Index starts from 0, so the 5th character is at index 4

// // 14. First line of an if statement that tests whether the 3rd character of a string represented by a variable is a particular character
// if (variable.charAt(2) === 'a') {
//   // Code here if the 3rd character is 'a'
// }

// // 15. For loop that cycles through all the characters of a string and assigns each character to an element of an array
// var array = [];
// for (var i = 0; i < reply.length; i++) {
//   array.push(reply.charAt(i));
// }

// // 16. Replace the first instance of "1" with "one" in a string and assign the revised string to newStr
// var newStr = str.replace("1", "one");

// // 17. Replace all instances of a character with another character in a string
// var y = x.replace(/a/g, "z"); // The "g" flag replaces all instances, so it will replace all occurrences of "a" with "z"

// var roundedNumber = Math.round(yourNumber);
// var roundNum = Math.ceil(origNum);
// var roundNum = Math.floor(origNum);
// var originalNumber = 7.89; // Replace this with your number
// var roundedResult = Math.round(originalNumber);
// var roundedValue = Math.round(0.5); // This will round 0.5 to 1, not 0
// var roundedDownValue = Math.floor(0.5); // This will round 0.5 down to 0



// var randomNumber = Math.floor(Math.random() * 50) + 1;
// var randomVariable = Math.random(); // Generates a random number between 0 and 1
...
//   // Usage
//   var diceResult = rollDice(); // Get the result of the dice roll
// // Function to simulate a coin toss (generating 0 or 1)
// function coinToss() {
//     return Math.floor(Math.random() * 2); // Generates either 0 or 1
//   }
  
//   // Usage
//   var tossResult = coinToss(); // Get the result of the coin toss (0 or 1)
//   if (tossResult === 0) {
//     console.log('Heads');
//   } else {
//     console.log('Tails');
...
//     return integer;
// }
// To convert a string containing a decimal number to a floating-point number in JavaScript, you can use parseFloat() function.
...
//     var integer = parseInt(str);
// }
// To convert a number to a string in JavaScript, you can use the toString() method or concatenate an empty string '' to the number.
...
// // The value of integer will be 3, as it truncates the decimal part.

// var num = 3.14159265359; // Replace this with your number
// var newNum = num.toFixed(4).toString();
// var variable = 5.6789; // Replace this with your number
// variable = parseFloat(variable.toFixed(2));
// if (num.toFixed(2).toString().length > 4) {
//     // Code here if the condition is true
// }
// var longNumber = 12.3456789; // Replace this with your number
